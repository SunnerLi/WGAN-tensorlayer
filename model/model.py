...
class WassersterinGAN(GAN):
    def __init__(self, img_channel, filter_base = 32, fc_unit_num = 1024, conv_depth = 4, lambda_panelty_factor = 10.0, name='wgan_'):
        super(WassersterinGAN, self).__init__(img_channel, filter_base, fc_unit_num, conv_depth, lambda_panelty_factor, name)
...
class DCGAN(GAN):
    def __init__(self, img_channel, filter_base = 32, fc_unit_num = 1024, conv_depth = 4, lambda_panelty_factor = 10.0, name='dcgan_'):
        super(DCGAN, self).__init__(img_channel, filter_base, fc_unit_num, conv_depth, lambda_panelty_factor, name)
