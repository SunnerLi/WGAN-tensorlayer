...
class GaussianGAN1(GAN):
    def __init__(self, img_channel, filter_base = 32, fc_unit_num = 1024, conv_depth = 2, lambda_panelty_factor = 10.0, name='ggan_'):
    ...
    def build(self, noise_ph, image_ph):
        ...
        for variable in self.variable_set:
            self.discriminator_loss += tf.contrib.layers.l2_regularizer(1e-4)(variable)
